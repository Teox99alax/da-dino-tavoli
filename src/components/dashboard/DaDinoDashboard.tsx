...
const selectedMapOption=useMemo(()=>options.find(o=>sameModules(o.moduleIds,selectedMapModules))||null,[selectedMapModules]);
...
function toggleMapModule(moduleId:string){
  setSelectedMapModules(prev=>{
    ...
    const found=options.find(o=>sameModules(o.moduleIds,next));
